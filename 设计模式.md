...
public class ProxyFactory {
    ...
    public Object getProxyInstance() {
         ...
         * 1.ClassLoader 指定当前类的类加载器
         * 2.Class<?>[] 被代理对象实现的接口集合
         * 3.InvocationHandler 目标对象 可以用于实现目标对象的方法
         */
...
public class TeacherDao {
    public void teach(){
        System.out.println("授课中,cglib不需要实现接口");
    }
}
```
